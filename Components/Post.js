         ...
         <>
            {
                ...
                <div className="flex flex-col gap-3 w-52 absolute right-0 z-10 bg-white shadow-md shadow-gray-300 rounded-md p-3 border dark:bg-darkcolorNav dark:shadow-none dark:border-none">
                 ...
                 Hide post</a>
                 {
                  user!==null && post.userId===user.id?<button className="flex gap-2  hover:bg-primary hover:text-white hover:shadow-md hover:rounded-md hover:scale-110 transition-all py-2" onClick={deletePsot}>
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
