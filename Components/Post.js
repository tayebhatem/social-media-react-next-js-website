  ...
  return (
    <Card>
        <div className="flex items-start justify-between">
          ...
          <p>
          <Link href={'/profile'}>
          <span className="font-semibold mr-1">Tayeb</span>
          </Link>
          
           shared an  
           <a className="text-primary font-medium"> album</a></p>
        ...
        <Avatar/>
         <div className="grow p-3 flex gap-2 border rounded-full">
         <input className="grow resize-none  outline-none" placeholder="Leave a comment..." />
         <button>
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
